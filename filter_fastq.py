...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', dest = 'input_file', required = True, help = 'Path to the input FASTQ file')
    parser.add_argument('--output_file', dest = 'output_file', required = True, help = 'Path to the output FASTQ file')
    parser.add_argument('--min_length', dest = 'min_length', required = True, type = int, help = 'minimum read length')
    parser.add_argument('--max_length', dest = 'max_length', required = True, type = int, help = 'maximum read length')
